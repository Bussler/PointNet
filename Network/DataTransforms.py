...
# translate object to origin (subtract mean) and  normalize points in unit sphere
# this is necessary, since point clouds can have different sizes, positions, rotations
...
# Data Augmentation by adding random rotation and noise to get more training data
